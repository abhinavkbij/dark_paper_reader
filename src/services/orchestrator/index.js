...
const config = {
    ...
    minio: {
        endpoint: process.env.MINIO_ENDPOINT || 'https://ec2-13-233-141-154.ap-south-1.compute.amazonaws.com:9000',
    ...
    apiBaseUrl: process.env.API_BASE_URL || `https://ec2-13-233-141-154.ap-south-1.compute.amazonaws.com`, // backend URL used in emails
    smtp: {
